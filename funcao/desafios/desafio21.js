...
function planoSaude(idade){
    ...
    if(idade < 10){
        return `Pessoas com ${idade} anos, pagam R$${mensalidade += 80}.`
    } else if(idade >= 10 && idade <= 30){
        return `Pessoas com ${idade} anos, pagam R$${mensalidade += 50}.`
    } else if(idade > 30 && idade <= 60){
        return `Pessoas com ${idade} anos, pagam R$${mensalidade += 95}.`
    } else if(idade > 60){
        return `Pessoas com ${idade} anos, pagam R$${mensalidade += 130}.`
    }
}

console.log(planoSaude(12))
