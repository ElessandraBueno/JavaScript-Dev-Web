...
function pontuacoesBasquete(stringPontuacoes){
    let pontuacoes = stringPontuacoes.split(", ")
    let qtd_vezes_quebra_records = 0
    let piorJogo = 1
    ...
    return [qtd_vezes_quebra_records, piorJogo]
}

console.log(pontuacoesBasquete(stringPontuacoes))